        ...
        [ Test.describe
                ...
                [ Test.test
                    ...
                    (\() ->
                        let
                            unused :
                                { string :
                                    Yafl.Field Example.FormModel Example.FormMsg Yafl.NoId String.String String.String
                                , bool :
                                    Yafl.Field Example.FormModel Example.FormMsg Yafl.NoId Basics.Bool Basics.Bool
                                }
                            unused =
                                Example.fields
                        in
            ...
            , Test.describe
                ...
                [ Test.test
                    ...
                    (\() ->
                        let
                            unused : Yafl.Field Example.FormModel Example.FormMsg Yafl.NoId String.String String.String
                            unused =
                ...
                , Test.test
                    ...
                    (\() ->
                        let
                            unused : Yafl.Field Example.FormModel Example.FormMsg Yafl.NoId Basics.Bool Basics.Bool
                            unused =
                                Example.isAdmin
                        in
                        Expect.pass
            ...
            , Test.describe
                ...
                [ Test.test
                    ...
                    (\() ->
                        let
                            unused : Yafl.Field Example.FormModel Example.FormMsg Yafl.NoId Basics.Never Example.User
                            unused =
                                Example.user
                        in
                        Expect.pass
            ...
            , Test.describe
                ...
                [ Test.test
                    ...
                    (\() ->
                        let
                            unused : Platform.Program () (Yafl.Model Example.FormModel) (Yafl.Msg Example.FormMsg)
                            unused =
                                main__Readme_4
                        in
                        Expect.pass
            ...
            , Test.describe
                ...
                [ Test.describe
                    ...
                    [ Test.test
                        ...
                        (\() ->
                            let
                                unused : Yafl.Field Fields.Model Fields.Msg Yafl.NoId String.String String.String
                                unused =
                    ...
                    , Test.test
                        ...
                        (\() ->
                            let
                                unused : Yafl.Field Fields.Model Fields.Msg Yafl.NoId String.String Basics.Float
                                unused =
                                    Fields.fields.string
                                        |> Yafl.label
            ...
            , Test.describe
                ...
                [ Test.describe
                    ...
                    , Test.test
                        ...
                        (\() ->
                            let
                                unused : Yafl.Field Fields.Model Fields.Msg Yafl.HasId String.String String.String
                                unused =
...
fields__Readme_1 =
    Yafl.defineFields (\string bool -> { string = string, bool = bool })
        |> Yafl.addWidget Example.stringWidget
        |> Yafl.addWidget Example.boolWidget
        |> Yafl.endFields
...
firstName__Readme_2 =
    Example.nonEmptyString |> Yafl.label "What is the user's first name?"


lastName__Readme_2 =
    Example.nonEmptyString |> Yafl.label "What is the user's last name?"


isAdmin__Readme_2 =
    Example.fields.bool |> Yafl.label "Is the user an admin?"


user__Readme_3 =
    Yafl.succeed Example.User
        |> Yafl.andMap Example.firstName
        |> Yafl.andMap Example.lastName
        |> Yafl.andMap Example.isAdmin


main__Readme_4 =
    Browser.element
        { init = \flags -> Yafl.init Example.user
        , update = \msg model -> Yafl.update Example.user msg model
        , view = \model -> Html.form [] (Yafl.view Example.user model)
        , subscriptions = \model -> Yafl.subscriptions Example.user model
        }
...
firstField__Yafl__andUpdateField_0 =
    Fields.fields.string |> Yafl.id "a-unique-string"


secondField__Yafl__andUpdateField_0 =
    Fields.fields.string |> Yafl.id "another-unique-string"
...
myAddressedField__Yafl__intercept_0 =
    Fields.fields.string |> Yafl.id "any-string-as-long-as-it's-unique"
